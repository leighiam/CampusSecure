package campussecure.display;

import campussecure.log.CampusLog;
import campussecure.log.User;
import java.time.*;
import java.util.*;
import java.io.*;
                    ...
                    if(log.checkCredentials(password, username, type) == true)
                    {
                        while(session)
                        {
                            ...
                            if(options3.equalsIgnoreCase("k"))
                            {
                                ...
                                else if(options4.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options4.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options3.equalsIgnoreCase("d"))
                            {
                                ...
                                else if(options5.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options5.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options3.equalsIgnoreCase("dv"))
                            {
                                ...
                                else if(options7.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                    ...
                    if(log.checkCredentials(password, username, type) == true)
                    {
                        while(session)
                        {
                            ...
                            if(options8.equalsIgnoreCase("k"))
                            {
                                ...
                                else if(options9.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options9.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("d"))
                            {
                                ...
                                else if(options10.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options10.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("p"))
                            {
                                ...
                                else if(options11.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("dv"))
                            {
                                ...
                                else if(options12.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options12.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("g"))
                            {
                                ...
                                else if(options13.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options13.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("v"))
                            {
                                ...
                                else if(options14.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options14.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options8.equalsIgnoreCase("e"))
                            {
                                log.saveLists();
                                goodbyeMessage();
                                break aa;
                    ...
                    if(log.checkCredentials(password, username, type) == true)
                    {
                        while(session)
                        {
                            ...
                            if(options15.equalsIgnoreCase("g"))
                            {
                                ...
                                else if(options16.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options16.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options15.equalsIgnoreCase("v"))
                            {
                                ...
                                else if(options17.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options17.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options15.equalsIgnoreCase("e"))
                            {
                                log.saveLists();
                                goodbyeMessage();
                                break aa;
                    ...
                    if(log.checkCredentials(password, username, type) == true)
                    {
                        while(session)
                        {
                            ...
                            else if(options18.equalsIgnoreCase("g"))
                            {
                                ...
                                else if(options19.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options19.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options18.equalsIgnoreCase("v"))
                            {
                                ...
                                else if(options20.equalsIgnoreCase("l"))
                                {
                                    log.saveLists();
                                    break bb;
                                }
                                else if(options20.equalsIgnoreCase("e"))
                                {
                                    log.saveLists();
                                    goodbyeMessage();
                                    break aa;
                            ...
                            else if(options18.equalsIgnoreCase("e"))
                            {
                                log.saveLists();
                                goodbyeMessage();
                                break aa;
